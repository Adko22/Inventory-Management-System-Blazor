...
namespace InventoryManagement.EFCoreSqlServer
{
    public class IMSContex : DbContext
    {
        public IMSContex(DbContextOptions<IMSContex> option) : base(option)
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(
              ...
              new Product() { ProductId = 3, ProductName = "Motor Bike", Quantity = 8, Price = 7500 }
                );
